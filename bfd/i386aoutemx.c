...
/* Avoid multiple defininitions from aoutx if supporting standard a.out
   as well as our own.  */
...
HOWTO ( 0,             0,  1,   8,  false, 0, complain_overflow_bitfield, MY(generic_reloc),"8",        true, 0x000000ff,0x000000ff, false),
HOWTO ( 1,             0,  2,   16, false, 0, complain_overflow_bitfield, MY(generic_reloc),"16",       true, 0x0000ffff,0x0000ffff, false),
HOWTO ( 2,             0,  4,   32, false, 0, complain_overflow_bitfield, MY(generic_reloc),"32",       true, 0xffffffff,0xffffffff, false),
HOWTO ( 3,             0,  8,   64, false, 0, complain_overflow_bitfield, MY(generic_reloc),"64",       true, 0xdeaddead,0xdeaddead, false),
HOWTO ( 4,             0,  1,   8,  true,  0, complain_overflow_signed,   MY(generic_reloc),"DISP8",    true, 0x000000ff,0x000000ff, false),
HOWTO ( 5,             0,  2,   16, true,  0, complain_overflow_signed,   MY(generic_reloc),"DISP16",   true, 0x0000ffff,0x0000ffff, false),
HOWTO ( 6,             0,  4,   32, true,  0, complain_overflow_signed,   MY(generic_reloc),"DISP32",   true, 0xffffffff,0xffffffff, false),
HOWTO ( 7,             0,  8,   64, true,  0, complain_overflow_signed,   MY(generic_reloc),"DISP64",   true, 0xfeedface,0xfeedface, false),
HOWTO ( 8,             0,  4,    0, false, 0, complain_overflow_bitfield, MY(generic_reloc),"GOT_REL",  false,         0,0x00000000, false),
HOWTO ( 9,             0,  2,   16, false, 0, complain_overflow_bitfield, MY(generic_reloc),"BASE16",   false,0xffffffff,0xffffffff, false),
HOWTO (10,             0,  4,   32, false, 0, complain_overflow_bitfield, MY(generic_reloc),"BASE32",   false,0xffffffff,0xffffffff, false),
EMPTY_HOWTO (-1),
EMPTY_HOWTO (-1),
EMPTY_HOWTO (-1),
EMPTY_HOWTO (-1),
EMPTY_HOWTO (-1),
  HOWTO (16,	       0,  4,	 0, false, 0, complain_overflow_bitfield, MY(generic_reloc),"JMP_TABLE", false,         0,0x00000000, false),
EMPTY_HOWTO (-1),
EMPTY_HOWTO (-1),
EMPTY_HOWTO (-1),
EMPTY_HOWTO (-1),
...
EMPTY_HOWTO (-1),
EMPTY_HOWTO (-1),
  HOWTO (32,	       0,  4,	 0, false, 0, complain_overflow_bitfield, MY(generic_reloc),"RELATIVE",  false,         0,0x00000000, false),
EMPTY_HOWTO (-1),
EMPTY_HOWTO (-1),
EMPTY_HOWTO (-1),
EMPTY_HOWTO (-1),
